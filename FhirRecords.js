var org_json_template=require("./org-jsontemplate");
var patient_json_template= require("./patient-jsontemplate");
var imageStudy_json_template=require("./ImageStudy-jsontemplate");
// let org_str=
...
class FhirRecord{
    ...
    create_org_json_info(id,name,web_url,mail,phone_num,addr){
    ...
    create_patient_json_info(id,family_name,given_name,gender,phone_num,mail,addr,org_id,org_url,org_name,isActive=true){
        let div_str= "<div xmlns=\"http://www.w3.org/1999/xhtml\">\n      \n      <p>Patient "+
    ...
    create_imageStudy_json_info(img_id,pat_id,org_id){
        let img = imageStudy_json_template;
        img.text.div="<div xmlns=\"http://www.w3.org/1999/xhtml\">CT images</div>"
        img.id=""+img_id;
